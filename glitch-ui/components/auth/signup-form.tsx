...
import { Eye, EyeOff, UserPlus, Zap, AlertCircle } from "lucide-react"
      ...
      <Card className={`w-full max-w-md bg-neutral-900/80 border-orange-500/30 backdrop-blur-sm relative z-10 ${glitchEffect ? 'animate-pulse' : ''}`}>
        <CardHeader className="text-center space-y-4">
          ...
          <CardTitle className="text-2xl font-bold text-white tracking-wider">
            <span className="text-orange-500">GLITCH</span> REGISTRATION
          </CardTitle>
        ...
        <CardContent className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="username" className="text-orange-500 font-mono text-sm">
                OPERATOR_NAME
              </Label>
              <Input
                id="name"
            ...
            >
              {state.isLoading ? (
                ...
                <span className="font-mono">CREATE OPERATOR</span>
              )}
            </Button>
          </form>
